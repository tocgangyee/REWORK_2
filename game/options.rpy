...
define config.name = _("Tower Of Babel")
...
define build.name = "TowerOfBabel"
...
define config.main_menu_music = "audio/Wind_grass.mp3"
...
## This is skip option value
default skip_trigger = None

## This is persistent data option value
# default persistent_reset_flag = 1

## This is for touch interaction (Long_touch)
...
# kill auto save function permanently
init python:
...
# set default value of skip function
